...
const activePlans: MaintenancePlanRecord[] = [
  {
    id: 'plan-gold-res',
    name: 'Gold Care HVAC Maintenance Agreement',
    quickbooksItemName: 'Maint-Res-Gold',
    description: 'Comprehensive bi-annual heating and cooling maintenance agreement including priority scheduling, zero diagnostic dispatch fees, and 15% discount on all repairs.',
    contractLength: '1 Year',
    annualPrice: 389.00,
    accountName: 'Agreements:Residential Gold',
    className: 'Residential',
    collectTax: false,
    autoRenewalReminders: true,
    termsType: 'editable',
    termsText: 'Gold Care includes two precision maintenance visits per year (Spring Cooling Tune-Up and Fall Heating Inspection). Plan members receive priority emergency dispatching and waived standard diagnostic fees.',
    frequency: 'Bi-Annual',
    serviceWindowsList: [
    ...
    serviceWindowJobType: 'Precision Maintenance Tune-Up',
    appointmentDurationHours: '1.5',
  },
  {
    id: 'plan-silver-res',
    name: 'Silver Care HVAC Maintenance Agreement',
    quickbooksItemName: 'Maint-Res-Silver',
    description: 'Annual precision system inspection, 21-point safety check, electrical amp draw evaluation, and 10% discount on all replacement parts.',
    contractLength: '1 Year',
    annualPrice: 249.00,
    accountName: 'Agreements:Residential Silver',
    className: 'Residential',
    collectTax: false,
    autoRenewalReminders: true,
    termsType: 'editable',
    termsText: 'Silver Care includes one comprehensive multi-point tune-up per year with safety inspection and priority booking windows.',
    frequency: 'Annual',
    serviceWindowsList: [
      { id: 'sw-1', beginningMonth: 'October', endMonth: 'November', visitTitle: 'Annual Comprehensive HVAC Tune-Up' },
    ],
    serviceWindowsSummary: ['October - November'],
    serviceWindowJobType: 'Precision Maintenance Tune-Up',
    appointmentDurationHours: '1.25',
  },
  {
    id: 'plan-platinum-iaq',
    name: 'Platinum Whole-Home HVAC & IAQ Care Agreement',
    quickbooksItemName: 'Maint-Res-Platinum',
    description: 'Premium tri-annual heating, cooling, and whole-home indoor air quality protection including MERV 13 media filter replacement and UV germicidal lamp service.',
    contractLength: '1 Year',
    annualPrice: 549.00,
    accountName: 'Agreements:Residential Platinum',
    className: 'Residential',
    collectTax: false,
    autoRenewalReminders: true,
    termsType: 'editable',
    termsText: 'Platinum Care provides three visits annually covering seasonal cooling prep, heating prep, and deep indoor air quality sanitization with 20% discount on repairs.',
    frequency: 'Tri-Annual',
    serviceWindowsList: [
      { id: 'sw-1', beginningMonth: 'March', endMonth: 'April', visitTitle: 'Spring Cooling Tune-Up & Coil Clean' },
      { id: 'sw-2', beginningMonth: 'July', endMonth: 'August', visitTitle: 'Mid-Year IAQ & Airflow Optimization' },
      { id: 'sw-3', beginningMonth: 'October', endMonth: 'November', visitTitle: 'Fall Heating Inspection & Safety Check' },
    ],
    serviceWindowsSummary: ['March - April', 'July - August', 'October - November'],
    serviceWindowJobType: 'Precision Maintenance Tune-Up',
    appointmentDurationHours: '2.0',
  },
  {
    id: 'plan-comm-qtr',
    name: 'Commercial Care Quarterly HVAC Preventive Agreement',
    quickbooksItemName: 'Maint-Comm-Quarterly',
    description: 'Commercial multi-unit packaged RTU and chiller maintenance agreement with quarterly belt tensioning, coil cleaning, economizer calibration, and 2-hour response guarantee.',
    contractLength: '1 Year',
    annualPrice: 1450.00,
    accountName: 'Agreements:Commercial Quarterly',
    className: 'Commercial',
    collectTax: false,
    autoRenewalReminders: true,
    termsType: 'editable',
    termsText: 'Commercial quarterly agreement includes four scheduled inspections, documented airflow reports, and discounted commercial parts pricing.',
    frequency: 'Quarterly',
    serviceWindowsList: [
      { id: 'sw-1', beginningMonth: 'January', endMonth: 'February', visitTitle: 'Q1 Winter Mechanical System Audit' },
      { id: 'sw-2', beginningMonth: 'April', endMonth: 'May', visitTitle: 'Q2 Spring Cooling & Economizer PM' },
      { id: 'sw-3', beginningMonth: 'July', endMonth: 'August', visitTitle: 'Q3 Summer High-Load Reliability Check' },
      { id: 'sw-4', beginningMonth: 'October', endMonth: 'November', visitTitle: 'Q4 Fall Heating & Safety Inspection' },
    ],
    serviceWindowsSummary: ['January - February', 'April - May', 'July - August', 'October - November'],
    serviceWindowJobType: 'Commercial Preventative Maintenance',
    appointmentDurationHours: '3.0',
  },
];
